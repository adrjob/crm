                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row  mt-4">
                                        ...
                                        <div class="col-md-4 col-sm-6 my-3 my-sm-0 mt-4">
                                            <div class="d-flex align-items-start">
                                                <div class="theme-avtar bg-primary mt-3">
                                                    <i class="ti ti-thumb-up"></i>
                                                </div>
                                                <div class="ms-2 mt-3">
                                                    <p class="text-muted text-sm mb-0">{{__('Price')}}:</p>
                                                    <h6 class="mb-0 text-primary">{{\Auth::user()->priceFormat($deal->price)}}</h6>
                                ...
                                <div class="dropzone dropzone-multiple" data-toggle="dropzone" data-dropzone-url="http://" data-dropzone-multiple>
                                    ...
                                    <ul class="dz-preview dz-preview-multiple list-group list-group-lg list-group-flush">
                                        <li class="list-group-item px-0">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                        <img class="dropzone" src="" alt="Image placeholder" data-dz-thumbnail>
