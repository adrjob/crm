                ...
                <div class="card card-body">
                    ...
                    <div class="row filter-css">
                        ...
                        <div class="action-btn bg-info ms-2">
                            <button type="submit" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-toggle="tooltip" data-title="{{__('Apply')}}"><i class="ti ti-search text-white"></i></button>
                        </div>
                        <div class="action-btn bg-danger ms-2">
                            <a href="{{route('meeting.index')}}" data-toggle="tooltip" data-title="{{__('Reset')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center"><i class="ti ti-trash text-white"></i></a>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
