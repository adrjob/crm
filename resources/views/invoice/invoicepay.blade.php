                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            @foreach($invoice->items as $invoiceitem)
                                                ...
                                                @endphp
                                                <tr>
                                                    <td class="px-2">{{$invoiceitem->item}} </td>
                        ...
                        <div class="card">
                            <ul class="nav nav-tabs nav-overflow profile-tab-list" role="tablist">
                                ...
                                (isset($payment_setting['paymentwall_private_key']) && !empty($payment_setting['paymentwall_private_key'])))
                                    <li class="nav-item ml-4">
                                        <a data-toggle="tab" href="#paymentwall-payment" class="nav-link" role="tab" aria-controls="paymentwall" aria-selected="false">{{ __('PaymentWall') }}</a>
                                    </li>
                                @endif
                            @endif
                            @endif
                                                    ...
                                                    <form role="form" action="{{ route('plan.paymentwallpayment') }}" method="post" class="require-validation" id="paymentwall-payment-form">
                                                        ...
                                                        <div class="form-group mt-3 mr-3">
                                                            <div class="text-sm-right">
                                                                <input type="submit" id="pay_with_paymentwall" value="{{__('Pay Now')}}" class="btn btn-primary btn-sm">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
